...
public class TransactionTestService {
     ...
     *
     * Therefore, if the outer transaction later rolls back,
     * this change can still remain committed.
     *
     * This is different from REQUIRED, which would normally
     * participate in the existing transaction.
     *
     * Important:
     * The transaction only works this way because operationB()
     * is called through another Spring-managed service.
     */
    ...
    public void operationB(Long id) {
         ...
         * Dirty Checking detects the change and Hibernate
         * generates the UPDATE when this transaction commits.
         */
    }
     ...
     *
     * By default, Spring rolls back transactions for unchecked
     * exceptions such as RuntimeException.
     *
     * Checked exceptions such as Exception do NOT normally
     * trigger a rollback.
     *
     * rollbackFor = Exception.class explicitly tells Spring:
     *
     * "Roll back this transaction when an Exception is thrown,
